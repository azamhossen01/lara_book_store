...
<div class="ht__bradcaump__area bg-image--5 bg-primary">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="wn__team text-center">
                    <div class="thumb">
                        <img src="{{asset('frontend')}}/images/about/team/4.jpg" alt="Team images">
                    </div>
                    <div class="content">
                        <h4>JOHN SMITH</h4>
                        <p>Store Head</p>
            ...
            <div class="col-lg-3">
                <div class="wn__team text-center">
                    <div class="thumb">
                        <img src="{{asset('frontend')}}/images/about/team/5.jpg" alt="Team images">
                    </div>
                    <div class="content">
                        <h4>ALICE KIM</h4>
                        <p>Co-Founder</p>
            ...
            <div class="col-lg-3">
                <div class="wn__team text-center">
                    <div class="thumb">
                        <img src="{{asset('frontend')}}/images/about/team/6.jpg" alt="Team images">
                    </div>
                    <div class="content">
                        <h4>ALICE KIM</h4>
                        <p>Founder</p>
