                    ...
                    <div class="shop-grid tab-pane fade" id="nav-list" role="tabpanel">
                        <div class="list__view__wrapper">
                            ...
                            <div class="list__view">
                                <div class="thumb">
                                    <a class="first__img" href="single-product.html"><img src="{{asset('frontend')}}/images/product/1.jpg" alt="product images"></a>
                                    <a class="second__img animation1" href="single-product.html"><img src="{{asset('frontend')}}/images/product/2.jpg" alt="product images"></a>
                                </div>
                                <div class="content">
                            ...
                            <div class="list__view mt--40">
                                <div class="thumb">
                                    <a class="first__img" href="single-product.html"><img src="{{asset('frontend')}}/images/product/2.jpg" alt="product images"></a>
                                    <a class="second__img animation1" href="single-product.html"><img src="{{asset('frontend')}}/images/product/4.jpg" alt="product images"></a>
                                </div>
                                <div class="content">
                            ...
                            <div class="list__view mt--40">
                                <div class="thumb">
                                    <a class="first__img" href="single-product.html"><img src="{{asset('frontend')}}/images/product/3.jpg" alt="product images"></a>
                                    <a class="second__img animation1" href="single-product.html"><img src="{{asset('frontend')}}/images/product/6.jpg" alt="product images"></a>
                                </div>
                                <div class="content">
                            ...
                            <div class="list__view mt--40">
                                <div class="thumb">
                                    <a class="first__img" href="single-product.html"><img src="{{asset('frontend')}}/images/product/4.jpg" alt="product images"></a>
                                    <a class="second__img animation1" href="single-product.html"><img src="{{asset('frontend')}}/images/product/6.jpg" alt="product images"></a>
                                </div>
                                <div class="content">
                            ...
                            <div class="list__view mt--40">
                                <div class="thumb">
                                    <a class="first__img" href="single-product.html"><img src="{{asset('frontend')}}/images/product/5.jpg" alt="product images"></a>
                                    <a class="second__img animation1" href="single-product.html"><img src="{{asset('frontend')}}/images/product/9.jpg" alt="product images"></a>
                                </div>
                                <div class="content">
